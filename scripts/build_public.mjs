...
<title>Lajora · The Seamless Stay</title>
<style>
...
<header><small>LAJORA · THE SEAMLESS STAY · PROJECT-LED EDITORIAL CAMPAIGN</small><h1>${publishedCount} live now.<br><b>${queuedCount} next.</b></h1><p>${plan.length} original visuals · ${imageOnlyCount} image-led posts · ${blankCaptionCount} captionless posts · English throughout</p></header>
